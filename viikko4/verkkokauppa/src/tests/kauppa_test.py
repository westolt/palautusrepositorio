...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            if tuote_id == 1:
                ...
                return Tuote(2, "sandels", 3)
            elif tuote_id == 3:
                return Tuote(3, "karhu", 2)
    ...
    def test_maksettaessa_ostos_pankin_metodilla_tilisiirto_oikea_asiakas_tilinimero_ja_summa(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_koriin_lisataan_kaksi_eri_tuotetta(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_koriin_lisataan_kaksi_samaa_tuotetta(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
    ...
    def test_koriin_lisataan_kaksi_tuotetta_joista_toinen_on_loppu(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
